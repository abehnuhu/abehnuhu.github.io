...
const PERFUME_DB = {
  ...
  'sage': { desc: 'Aromatic sage, white tea, and soft woods. Clean, herbal, and effortlessly refined.', notes: 'Sage, White Tea, Woods' },
  'fire embrace': { desc: 'Warm amber, cinnamon, and smoky woods. A fiery, passionate blend — intense and captivating.', notes: 'Amber, Cinnamon, Smoky Woods' },
  'tessa coffee': { desc: 'Rich espresso, dark chocolate, and vanilla. Bold, energising, and irresistibly warm.', notes: 'Coffee, Dark Chocolate, Vanilla' },
  'bab na\'s flame': { desc: 'Spicy cardamom, smoky oud, and warm amber. Bold and fiery — a statement Arabian fragrance.', notes: 'Cardamom, Oud, Amber' },
  'shally smoke': { desc: 'Smoky vetiver, black pepper, and leather. Dark, mysterious, and powerfully masculine.', notes: 'Vetiver, Black Pepper, Leather' },
  'tobacco touch': { desc: 'Sweet tobacco leaf, honey, and cedar. Rich, warm, and intoxicatingly smooth.', notes: 'Tobacco, Honey, Cedar' },
  'predeco solis': { desc: 'Bright citrus, solar notes, and white musk. A sunlit, uplifting everyday fragrance.', notes: 'Citrus, Solar Notes, White Musk' },
  'v rekindle blue': { desc: 'Fresh aquatic notes, lavender, and amber. Cool and invigorating with a warm finish.', notes: 'Aquatic, Lavender, Amber' },
  'spendid': { desc: 'Sweet vanilla, tonka bean, and sandalwood. Warm, smooth, and effortlessly appealing.', notes: 'Vanilla, Tonka, Sandalwood' },
  'tony iommy': { desc: 'Bold oud, black leather, and dark amber. Powerful and commanding — a rock-solid signature.', notes: 'Oud, Leather, Dark Amber' },
  'oud lattiss': { desc: 'Deep oud, rose, and saffron over musk. Opulent Arabian oud — rich and long-lasting.', notes: 'Oud, Rose, Saffron, Musk' },
  'leodore red': { desc: 'Red berries, rose, and warm amber. A romantic, passionate blend with lasting depth.', notes: 'Red Berries, Rose, Amber' },
  'ameer al oudh': { desc: 'Royal oud, saffron, and smoky incense. A majestic Arabian oud — deep, complex, and regal.', notes: 'Oud, Saffron, Incense' },
  'awen serene': { desc: 'Delicate florals, soft musk, and pear. Graceful, serene, and beautifully feminine.', notes: 'Florals, Musk, Pear' },
  'magic voyage': { desc: 'Exotic spices, citrus, and amber. An adventurous journey in a bottle — bold and worldly.', notes: 'Spices, Citrus, Amber' },
  'noir': { desc: 'Dark vetiver, black pepper, and leather. Mysterious and sophisticated — pure noir elegance.', notes: 'Vetiver, Black Pepper, Leather' },
  'exile scents': { desc: 'Woody cedar, bergamot, and white musk. Clean and refined with an understated edge.', notes: 'Cedar, Bergamot, White Musk' },
  'l707 men': { desc: 'Fresh citrus, aquatic notes, and sandalwood. Modern, clean, and effortlessly cool.', notes: 'Citrus, Aquatic, Sandalwood' },
  'bouquet immortel': { desc: 'Eternal florals, jasmine, and soft vanilla. A timeless bouquet — elegant and enchanting.', notes: 'Florals, Jasmine, Vanilla' },
  'rhythm immortel silver': { desc: 'Cool metallic notes, lavender, and musk. Sleek, modern, and silver-smooth.', notes: 'Metallic Notes, Lavender, Musk' },
  'masafi': { desc: 'Fresh aquatic notes, lemon, and cedar. Light and breezy — like a cool desert wind.', notes: 'Aquatic, Lemon, Cedar' },
  'slaycy dfp': { desc: 'Rich oud, amber, and warm spices. Bold Arabian luxury — designed to slay.', notes: 'Oud, Amber, Spices' },
  'intense le cidre': { desc: 'Crisp apple, cinnamon, and warm woods. An intense autumn cider — cosy and inviting.', notes: 'Apple, Cinnamon, Warm Woods' },
  'serene blue le man': { desc: 'Fresh ocean breeze, blue iris, and cedar. Calm confidence in every spray.', notes: 'Ocean Breeze, Blue Iris, Cedar' },
  'apple cider vinegar': { desc: 'Tart apple, warm spices, and amber. A quirky, bold gourmand — unexpected and addictive.', notes: 'Apple, Spices, Amber' },
  'house of baiden kilian': { desc: 'Rich vanilla, rum, and dark chocolate. Opulent gourmand luxury — House of Baiden exclusive.', notes: 'Vanilla, Rum, Dark Chocolate' },
  'liquide illusion': { desc: 'Smooth vanilla, soft musk, and crystalline amber. An illusion of liquid silk on skin.', notes: 'Vanilla, Musk, Amber' },
  'raw ambition': { desc: 'Leather, oud, black pepper, and amber. Bold, confident, and impossible to ignore.', notes: 'Leather, Oud, Pepper, Amber' },
  'milky toffee': { desc: 'Creamy toffee, vanilla, and caramel. A warm gourmand — like biting into a luxury sweet.', notes: 'Toffee, Vanilla, Caramel' },
  'amiri oud': { desc: 'Rich oud, rose, and saffron over a deep amber base. Opulent and long-lasting Arabian luxury.', notes: 'Oud, Rose, Saffron, Amber' },
  'oud ispahan': { desc: 'Rose, oud, raspberry, and patchouli. A romantic floral-oud masterpiece — elegant and mysterious.', notes: 'Rose, Oud, Raspberry, Patchouli' },
  '19 pour homme': { desc: 'Citrus, aquatic notes, and musk. Fresh yet masculine — a versatile everyday signature.', notes: 'Citrus, Aquatic, Musk' },
  'alexander no.1 supreme vanille': { desc: 'Rich Madagascar vanilla, tonka bean, and soft musk. A luxurious gourmand — sweet and addictive.', notes: 'Vanilla, Tonka, Musk' },
  'tonka lavender': { desc: 'Lavender, tonka bean, and cedarwood. Aromatic and warm — refined masculine elegance.', notes: 'Lavender, Tonka, Cedarwood' },
  'black toffee': { desc: 'Dark toffee, coffee, vanilla, and amber. Rich and indulgent — like liquid luxury.', notes: 'Toffee, Coffee, Vanilla, Amber' },
  'french woods': { desc: 'Cedar, bergamot, vetiver, and white musk. A refined French-inspired woody — clean and sophisticated.', notes: 'Cedar, Bergamot, Vetiver, Musk' },
  'milano': { desc: 'Citrus, lavender, leather, and sandalwood. Italian elegance in a bottle — polished and confident.', notes: 'Citrus, Lavender, Leather, Sandalwood' },
  'imagination': { desc: 'Black tea, citrus, and sandalwood. Clean, intellectual, and effortlessly cool.', notes: 'Black Tea, Citrus, Sandalwood' },
  'zenith elixir': { desc: 'Oud, saffron, rose, and amber. An intense, opulent Arabian elixir — luxurious and unforgettable.', notes: 'Oud, Saffron, Rose, Amber' },
  'pride of cherlsten': { desc: 'Oud, leather, tobacco, and dark amber. Bold, smoky, and powerfully masculine.', notes: 'Oud, Leather, Tobacco, Amber' },
  'english laundry no.7': { desc: 'Bergamot, violet, musk, and amber. Clean English gentleman — sophisticated yet approachable.', notes: 'Bergamot, Violet, Musk, Amber' },
};
