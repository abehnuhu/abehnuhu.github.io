...
const PERFUME_DB = {
  ...
  // ==================== SKINCARE PRODUCTS ====================
  'dr pure vitamin c brightening serum': { desc: 'Lightweight Vitamin C serum that brightens skin and fades dark spots for glowing results', notes: 'Vitamin C (Sodium Ascorbyl Phosphate), Niacinamide, Hyaluronic Acid' },
  'mr bears dead skin/scrub': { desc: 'Gentle face and body scrub that removes dead skin cells for smoother, softer skin', notes: 'Aloe Vera, Safflower Oil, Birch Leaf Extract, Silica Beads' },
  '100% rel aloe vera': { desc: 'Pure soothing aloe gel that hydrates, calms irritation, and heals sun-damaged skin', notes: 'Pure Aloe Barbadensis Leaf Juice, Panthenol, Glycerin' },
  'dr becks dead skin/scrub': { desc: 'Exfoliating sugar scrub that buffs away dead skin while moisturising with natural oils', notes: 'Sugar Crystals, Coconut Oil, Honey, Jojoba Beads, Vitamin E' },
  'grapeseed instant radiance serum': { desc: 'Lightweight antioxidant serum that brightens dull skin and protects against environmental damage', notes: 'Grapeseed Oil, Vitamin E, Linoleic Acid, Antioxidants' },
  'rosewater garden glamour toner': { desc: 'Soothing rose toner that balances pH, hydrates, and reduces redness for calm skin', notes: 'Rosa Damascena Flower Water, Glycerin, Natural Rose Extract' },
  'yes to tomatoes scrub': { desc: 'Detoxifying charcoal scrub that deep-cleans pores and prevents acne breakouts', notes: 'Activated Charcoal, Tomato Extract, Salicylic Acid, PLA Exfoliating Particles' },
  'oil free moisturising honey water': { desc: 'Oil-free honey gel moisturiser that hydrates without clogging pores or feeling greasy', notes: 'Honey Extract, Aloe Vera, Hyaluronic Acid, Propolis' },
  'dr rashel vitamin c serum': { desc: 'Brightening Vitamin C serum that fades dark spots, boosts collagen, and plumps skin', notes: 'Ethyl Ascorbic Acid (Vitamin C), Hyaluronic Acid, Collagen, Ceramides' },
  'kojie san soap': { desc: 'Original Kojic Acid soap that lightens dark spots, acne marks, and evens skin tone', notes: 'Kojic Acid, Coconut Oil, Glycerin, Vitamin C, Orange Fragrance' },
  'gluta whitening body lotion': { desc: 'Whitening body lotion with glutathione that brightens skin while improving elasticity', notes: 'Glutathione, Collagen, Carrot Extract, Papaya Extract, Vitamin C' },
  'positive shower gel': { desc: 'Refreshing shower gel that cleanses without stripping skin of its natural moisture', notes: 'Coconut Oil, Aloe Vera, Glycerin, Vitamin E, Gentle Surfactants' },
  'rosehip beauty oil': { desc: 'Luxurious facial oil rich in antioxidants that fades scars, evens tone, and fights aging', notes: 'Rosehip Seed Oil (Rosa Canina), Vitamin E, Omega Fatty Acids, Beta-Carotene' },
  'body korean lactic acid': { desc: 'Korean-style exfoliating lotion with lactic acid that smooths texture and brightens skin', notes: 'Lactic Acid (AHA), Ceramides, Hyaluronic Acid, Niacinamide' },
  'dr rashel whitening scrub': { desc: 'Brightening face and body scrub with niacinamide that exfoliates and reveals radiant skin', notes: 'Niacinamide, Arbutin, Walnut Shell Powder, Glycerin, Vitamin C' },
  'dr rashel whitening body milk': { desc: 'Affordable whitening body milk that brightens, nourishes, and provides sun protection', notes: 'Vitamin C, Calamansi Extract, Aloe Vera, Hyaluronic Acid, Sunscreen Agents' },
  'duo rose cleanser': { desc: 'Gentle rose-infused cleanser that removes impurities while keeping skin soft and hydrated', notes: 'Rose Water (Rosa Damascena), Rosehip Oil, Glycerin, Decyl Glucoside, Aloe Vera' },
  'raw shea butter': { desc: 'Pure unrefined shea butter that deeply moisturises, heals dry skin, and improves elasticity', notes: '100% Unrefined Shea Butter (Butyrospermum Parkii), Vitamin A, Vitamin E, Fatty Acids' },
  'glow body moisturizer': { desc: 'Hydrating body cream that moisturises deeply while enhancing skin\'s natural glow', notes: 'Shea Butter, Hyaluronic Acid, Aloe Vera, Vitamin E, Niacinamide' },
  'fruit emollient balm': { desc: 'Multi-purpose emollient balm that heals chapped lips and deeply moisturises dry patches', notes: 'Coconut Oil, Beeswax, Fruit Kernel Oils (Apricot, Plum, Cherry), Vitamin E, Shea Butter' },
  'vitamin e body oil': { desc: 'Rich antioxidant body oil that repairs skin barrier, fades stretch marks, and locks in moisture', notes: 'Tocopherol (Vitamin E), Jojoba Oil, Sweet Almond Oil, Grapeseed Oil, Argan Oil' },
  'olive oil soap': { desc: 'Gentle castile-style soap that cleanses without stripping skin\'s natural oils', notes: 'Olive Oil (Olea Europaea), Coconut Oil, Vitamin E, Natural Glycerin' },
  'panthenol niacinamide moisturizer': { desc: 'Barrier-repair moisturiser with panthenol that soothes, strengthens, and deeply hydrates skin', notes: 'Panthenol (Vitamin B5), Niacinamide, Ceramides, Hyaluronic Acid, Centella Asiatica' },
  'amlactin vitamin c body lotion': { desc: 'Exfoliating body lotion with AHA and Vitamin C that brightens and smooths rough, dry skin', notes: 'Lactic Acid (7%), Vitamin C (Ascorbic Acid), Ceramides, Glycerin, Ammonium Lactate' },
  'isdin water fusion sunscreen': { desc: 'Water-light invisible sunscreen with SPF 50 that hydrates while protecting from UV damage', notes: 'Avobenzone, Homosalate, Octisalate, Octocrylene, Hyaluronic Acid, Mediterranean Algae Extract, Vitamin E' },
  'la roche posay anthelios sunscreen': { desc: 'Dermatologist-tested high-protection sunscreen for sensitive skin with advanced UV filters', notes: 'Avobenzone, Homosalate, Octisalate, Octocrylene, Cell-Ox Shield Technology, Glycerin, Thermal Spring Water' },
  'palmer\'s cocoa butter': { desc: 'Classic cocoa butter formula that heals extremely dry skin and helps improve skin tone and texture', notes: 'Cocoa Butter, Vitamin E, Mineral Oil, Palm Kernel Oil, Fragrance' },
