...
const PERFUME_DB = {
  ...
  // ==================== SKINCARE PRODUCTS ====================
  'dr pure vitamin c brightening serum': { desc: 'Vitamin C, hyaluronic acid, niacinamide. Brightens skin, fades dark spots, and evens skin tone. A daily glow booster.', notes: 'Vitamin C, Hyaluronic Acid, Niacinamide' },
  'vitamin c brightening serum': { desc: 'Vitamin C, hyaluronic acid, niacinamide. Brightens skin, fades dark spots, and evens skin tone. A daily glow booster.', notes: 'Vitamin C, Hyaluronic Acid, Niacinamide' },
  'mr bears dead skin': { desc: 'Exfoliating scrub that removes dead skin cells, unclogs pores, and reveals smoother, brighter skin underneath.', notes: 'Exfoliating Beads, Salicylic Acid' },
  '100% rel aloe vera': { desc: 'Pure aloe vera gel. Soothes sunburn, hydrates skin, and calms irritation. A versatile skincare staple.', notes: 'Pure Aloe Vera' },
  'aloe vera': { desc: 'Pure aloe vera gel. Soothes sunburn, hydrates skin, and calms irritation. A versatile skincare staple.', notes: 'Pure Aloe Vera' },
  'dr becks dead skin': { desc: 'Dead skin exfoliating scrub. Buffs away rough patches and reveals fresh, smooth, radiant skin.', notes: 'Exfoliating Granules, Glycerin' },
  'grapeseed instant radiance serum': { desc: 'Grapeseed oil and vitamin E. Lightweight serum that absorbs quickly, hydrates, and gives an instant radiance boost.', notes: 'Grapeseed Oil, Vitamin E, Hyaluronic Acid' },
  'radiance serum': { desc: 'Lightweight serum that absorbs quickly, hydrates, and gives an instant radiance boost.', notes: 'Grapeseed Oil, Vitamin E' },
  'rosewater garden glamour toner': { desc: 'Rosewater-based toner that balances pH, tightens pores, and leaves skin feeling refreshed and hydrated.', notes: 'Rosewater, Glycerin, Aloe Vera' },
  'rosewater toner': { desc: 'Rosewater-based toner that balances pH, tightens pores, and leaves skin feeling refreshed and hydrated.', notes: 'Rosewater, Glycerin' },
  'yes to tomatoes scrub': { desc: 'Tomato-based exfoliating scrub. Fights blemishes, unclogs pores, and leaves skin clear and refreshed.', notes: 'Tomato Extract, Salicylic Acid' },
  'oil free moisturising honey water': { desc: "Oil-free moisturiser with honey extract. Lightweight hydration that won't clog pores — perfect for oily and combination skin.", notes: 'Honey Extract, Hyaluronic Acid, Aloe Vera' },
  'honey water moisturiser': { desc: "Oil-free moisturiser with honey extract. Lightweight hydration that won't clog pores — perfect for oily and combination skin.", notes: 'Honey Extract, Hyaluronic Acid' },
  'dr rashel vitamin c serum': { desc: 'Vitamin C serum that brightens complexion, reduces hyperpigmentation, and protects against environmental damage.', notes: 'Vitamin C, Vitamin E, Niacinamide' },
  'kojie san soap': { desc: 'Kojic acid whitening soap. Lightens dark spots, evens skin tone, and exfoliates for a brighter complexion.', notes: 'Kojic Acid, Glycerin' },
  'gluta whitening body lotion': { desc: 'Glutathione-enriched body lotion. Whitens, moisturises, and smooths skin for an even, radiant glow.', notes: 'Glutathione, Vitamin C, Shea Butter' },
  'positive shower gel': { desc: 'Refreshing shower gel that cleanses gently while keeping skin soft and hydrated. A positive start to your day.', notes: 'Aloe Vera, Vitamin E' },
  'rosehip beauty oil': { desc: 'Rosehip seed oil rich in vitamins A and C. Repairs skin, reduces scars, and gives a natural dewy glow.', notes: 'Rosehip Seed Oil, Vitamin A, Vitamin C' },
  'body korean lactic acid': { desc: 'Lactic acid exfoliating treatment. Dissolves dead skin, smooths rough texture, and reveals baby-soft skin.', notes: 'Lactic Acid, Shea Butter, Vitamin E' },
  'korean lactic acid': { desc: 'Lactic acid exfoliating treatment. Dissolves dead skin, smooths rough texture, and reveals baby-soft skin.', notes: 'Lactic Acid, Shea Butter' },
  'dr rashel whitening scrub': { desc: 'Whitening exfoliating scrub that removes dead skin, brightens complexion, and leaves skin silky smooth.', notes: 'Kojic Acid, Vitamin C, Exfoliating Beads' },
  'dr rashel whitening body milk': { desc: 'Whitening body milk that deeply moisturises, evens skin tone, and leaves a soft, radiant finish.', notes: 'Glutathione, Vitamin C, Shea Butter' },
  'duo rose cleanser': { desc: 'Rose-infused cleanser that gently removes makeup and impurities while nourishing and hydrating skin.', notes: 'Rose Extract, Glycerin, Vitamin E' },
  'raw shea butter': { desc: 'Pure unrefined shea butter. Deeply moisturises, heals dry skin, and protects against harsh weather. A natural powerhouse.', notes: 'Unrefined Shea Butter, Vitamins A & E' },
  'shea butter': { desc: 'Pure unrefined shea butter. Deeply moisturises, heals dry skin, and protects against harsh weather. A natural powerhouse.', notes: 'Unrefined Shea Butter, Vitamins A & E' },
  'glow body moisturizer': { desc: 'Body moisturiser that locks in hydration, smooths skin texture, and leaves a healthy, dewy glow all day.', notes: 'Hyaluronic Acid, Vitamin E, Aloe Vera' },
  'fruit emollient balm': { desc: 'Fruit-enriched emollient balm that softens, protects, and deeply nourishes dry, chapped skin.', notes: 'Fruit Extracts, Shea Butter, Vitamin E' },
  'vitamin e body oil': { desc: 'Vitamin E enriched body oil. Locks in moisture, improves skin elasticity, and gives a silky, smooth finish.', notes: 'Vitamin E, Sweet Almond Oil, Jojoba Oil' },
  'olive oil soap': { desc: 'Traditional olive oil soap. Gentle cleansing that moisturises while it cleans — suitable for all skin types.', notes: 'Olive Oil, Glycerin' },
  'panthenol niacinamide moisturizer': { desc: 'Panthenol and niacinamide moisturiser. Strengthens skin barrier, reduces redness, and provides long-lasting hydration.', notes: 'Panthenol, Niacinamide, Hyaluronic Acid' },
  'niacinamide moisturizer': { desc: 'Panthenol and niacinamide moisturiser. Strengthens skin barrier, reduces redness, and provides long-lasting hydration.', notes: 'Panthenol, Niacinamide' },
  'amlactin vitamin c body lotion': { desc: 'Amlactin body lotion with vitamin C. Exfoliates with lactic acid while brightening and deeply moisturising skin.', notes: 'Lactic Acid, Vitamin C, Shea Butter' },
  'isdin water fusion sunscreen': { desc: 'Lightweight water-fusion sunscreen SPF50. Invisible finish, non-greasy, and provides broad-spectrum UV protection.', notes: 'SPF50, Hyaluronic Acid, Vitamin E' },
  'sunscreen': { desc: 'Lightweight sunscreen SPF50. Invisible finish, non-greasy, and provides broad-spectrum UV protection.', notes: 'SPF50, Zinc Oxide' },
  'la roche posay': { desc: 'Anthelios sunscreen SPF50+. Dermatologist-recommended, ultra-light texture, and maximum UV protection for sensitive skin.', notes: 'SPF50+, Mexoryl, Vitamin E' },
  'palmers cocoa butter': { desc: 'Cocoa butter formula that deeply moisturises, improves skin elasticity, and helps fade scars and stretch marks.', notes: 'Cocoa Butter, Vitamin E, Shea Butter' },
  'cocoa butter': { desc: 'Cocoa butter formula that deeply moisturises, improves skin elasticity, and helps fade scars and stretch marks.', notes: 'Cocoa Butter, Vitamin E' },

  // ==================== HOUSE OF BAIDEN PRODUCTS ====================
  'tofy milky vanilla': { desc: 'Opens with a creamy milk note that feels warm and comforting, blending into rich cocoa and soft jasmine. Dries down to a gourmand base of vanilla and sandalwood — like a cozy vanilla milkshake in a bottle.', notes: 'Milk, Cocoa, Jasmine, Vanilla, Sandalwood' },
  'imperial noir by riiffs': { desc: 'A sophisticated masculine fragrance opening with spicy pink pepper and herbal clary sage over bright bergamot. The heart reveals smoky patchouli and resinous myrrh, settling into a warm base of vanilla bean, tonka, and light amber. Dark, elegant, and commanding.', notes: 'Pink Pepper, Clary Sage, Bergamot, Patchouli, Myrrh, Vanilla Bean, Tonka, Light Amber' },
  'imperial noir': { desc: 'A sophisticated masculine fragrance opening with spicy pink pepper and herbal clary sage over bright bergamot. The heart reveals smoky patchouli and resinous myrrh, settling into a warm base of vanilla bean, tonka, and light amber. Dark, elegant, and commanding.', notes: 'Pink Pepper, Clary Sage, Bergamot, Patchouli, Myrrh, Vanilla Bean, Tonka, Light Amber' },
  'lattafa bade\'e al oud - oud for glory': { desc: 'An intense oriental masterpiece opening with luxurious saffron, warm nutmeg, and aromatic lavender. The heart is dominated by rich agarwood (oud) and earthy patchouli, while musk anchors the deep, long-lasting dry-down. Powerful and regal — a true statement fragrance.', notes: 'Saffron, Nutmeg, Lavender, Agarwood (Oud), Patchouli, Musk' },
  'lattafa bade\'e al oud': { desc: 'An intense oriental masterpiece opening with luxurious saffron, warm nutmeg, and aromatic lavender. The heart is dominated by rich agarwood (oud) and earthy patchouli, while musk anchors the deep, long-lasting dry-down. Powerful and regal — a true statement fragrance.', notes: 'Saffron, Nutmeg, Lavender, Agarwood (Oud), Patchouli, Musk' },
  'hardcore wood by fragrance world': { desc: 'Opens with fresh hatkora citrus, lemon, and juicy peach, spiced with ginger and saffron. The heart blooms with rose and lavender before diving into a woody base of agarwood, sandalwood, musk, and ambergris. A complex, layered woody fragrance with surprising freshness.', notes: 'Hatkora, Lemon, Peach, Ginger, Saffron, Rose, Lavender, Agarwood, Sandalwood, Musk, Ambergris' },
  'hardcore wood': { desc: 'Opens with fresh hatkora citrus, lemon, and juicy peach, spiced with ginger and saffron. The heart blooms with rose and lavender before diving into a woody base of agarwood, sandalwood, musk, and ambergris. A complex, layered woody fragrance with surprising freshness.', notes: 'Hatkora, Lemon, Peach, Ginger, Saffron, Rose, Lavender, Agarwood, Sandalwood, Musk, Ambergris' },
  'sage': { desc: 'A fresh aromatic fragrance with crisp bergamot, green apple, and zesty ginger top notes. The heart features calming lavender and herbaceous sage, settling into a clean base of tonka bean and cedarwood. Fresh, clean, and effortlessly wearable for any setting.', notes: 'Bergamot, Apple, Ginger, Lavender, Sage, Tonka Bean, Cedarwood' },
  'fire embrace': { desc: 'A fiery, seductive fragrance opening with juicy black raspberry, warm cinnamon, and boozy cognac. The heart unfolds with frozen rose petals, sweet caramel, and moss, drying down to a woody base of oakwood, myrrh, cedarwood, and ambroxan. Warm, intoxicating, and unforgettable.', notes: 'Black Raspberry, Cinnamon, Cognac, Frozen Rose Petals, Caramel, Moss, Oakwood, Myrrh, Cedarwood, Ambroxan' },
  'tessa coffee': { desc: 'A rich gourmand centered around bold black coffee blended with bittersweet dark chocolate. Sweetened with creamy vanilla, caramel, and tonka bean, this fragrance captures the essence of a premium coffeehouse dessert. Addictive, comforting, and deliciously modern.', notes: 'Coffee, Dark Chocolate, Vanilla, Caramel, Tonka Bean' },
  'bab na\'s flame': { desc: 'Ignites with spicy saffron, nutmeg, and cinnamon before blooming into a floral heart of jasmine, patchouli, and incense. The base smolders with tobacco, vanilla, musk, and oud — creating a mysterious, passionate aura that commands attention.', notes: 'Saffron, Nutmeg, Cinnamon, Jasmine, Patchouli, Incense, Tobacco, Vanilla, Musk, Oud' },
  'shally smoke': { desc: 'A warm, boozy, and smoky fragrance evoking aged whisky in an oak barrel. Features smoky oak, rich whisky accord, and smooth vanilla blended with sandalwood. Notes of tobacco, leather, and amber add depth and sophistication. Masculine, rugged, and refined.', notes: 'Smoky Oak, Whisky, Vanilla, Sandalwood, Tobacco, Leather, Amber' },
  'tobacco touch': { desc: 'Opens with rich tobacco leaf and warm spices, developing into a sweet heart of vanilla, tonka bean, and cacao. The dry-down features dried fruits and woody notes for added depth. A warm, inviting tobacco fragrance that\'s both sophisticated and approachable.', notes: 'Tobacco, Spicy Notes, Vanilla, Tonka Bean, Cacao, Dried Fruits, Woody Notes' },
  'predeco solis': { desc: 'A sun-drenched citrus fragrance bursting with lime, bergamot, grapefruit, neroli, and crisp apple. The heart reveals delicate rose, while coconut, cashmeran, and cedar create a smooth, modern dry-down. Bright, uplifting, and effortlessly fresh like golden sunshine.', notes: 'Lime, Bergamot, Grapefruit, Neroli, Apple, Rose, Coconut, Cashmeran, Cedar' },
  'v rekindle blue by fragrance world': { desc: 'A fresh fougère-style fragrance opening with bright bergamot, lemon, and aromatic lavender. The heart and base feature clean cedarwood, earthy vetiver, soft musk, and warm amber. Crisp, professional, and versatile — perfect for the modern man\'s daily rotation.', notes: 'Bergamot, Lemon, Lavender, Cedarwood, Vetiver, Musk, Amber' },
  'v rekindle blue': { desc: 'A fresh fougère-style fragrance opening with bright bergamot, lemon, and aromatic lavender. The heart and base feature clean cedarwood, earthy vetiver, soft musk, and warm amber. Crisp, professional, and versatile — perfect for the modern man\'s daily rotation.', notes: 'Bergamot, Lemon, Lavender, Cedarwood, Vetiver, Musk, Amber' },
  'spendid by super ride': { desc: 'Opens with a bracing blend of juniper berries, herbaceous sage, and bright bergamot. The heart introduces a unique wormwood note before settling into a smooth base of vanilla, cedar, and musk. Fresh yet distinctive — an energetic scent for the adventurous spirit.', notes: 'Juniper Berries, Sage, Bergamot, Vanilla, Wormwood, Cedar, Musk' },
  'spendid': { desc: 'Opens with a bracing blend of juniper berries, herbaceous sage, and bright bergamot. The heart introduces a unique wormwood note before settling into a smooth base of vanilla, cedar, and musk. Fresh yet distinctive — an energetic scent for the adventurous spirit.', notes: 'Juniper Berries, Sage, Bergamot, Vanilla, Wormwood, Cedar, Musk' },
  'tony iommy': { desc: 'A rock-inspired luxury fragrance opening with rum, tropical passionfruit, geranium, and bergamot. The heart features cinnamon, Singapore patchouli, leather, and Bulgarian rose, while caramel, musk, vanilla, and sandalwood create an addictive dry-down. Bold, glamorous, and unforgettable.', notes: 'Rum, Passionfruit, Geranium, Bergamot, Cinnamon, Singapore Patchouli, Leather, Bulgarian Rose, Caramel, Musk, Vanilla, Sandalwood' },
  'oud lattiss': { desc: 'A rich oud-centric fragrance opening with rose, saffron, and spicy pimento. The heart is dominated by agarwood (oud), caramel, florals, and patchouli, while woody notes, amber, resins, incense, and musk create a complex, long-lasting finish. Deep, luxurious, and Eastern-inspired.', notes: 'Rose, Saffron, Pimento, Agarwood (Oud), Caramel, Floral Notes, Patchouli, Woody Notes, Amber, Resins, Incense, Musk' },
  'leodore red by lattafa': { desc: 'A vibrant floral-oriental opening with blood orange, pear, pink pepper, and cardamom. The opulent heart features jasmine, tuberose, Brazilian rosewood, cognac, and heliotrope, drying down to woody notes and amber. Bold, feminine, and celebratory — a red-carpet-ready scent.', notes: 'Blood Orange, Pear, Pink Pepper, Cardamom, Jasmine, Tuberose, Brazilian Rosewood, Cognac, Heliotrope, Woody Notes, Amber' },
  'leodore red': { desc: 'A vibrant floral-oriental opening with blood orange, pear, pink pepper, and cardamom. The opulent heart features jasmine, tuberose, Brazilian rosewood, cognac, and heliotrope, drying down to woody notes and amber. Bold, feminine, and celebratory — a red-carpet-ready scent.', notes: 'Blood Orange, Pear, Pink Pepper, Cardamom, Jasmine, Tuberose, Brazilian Rosewood, Cognac, Heliotrope, Woody Notes, Amber' },
  'ameer al oudh by lattafa': { desc: 'Opens with woody notes and rich agarwood (oud), often with touches of saffron and nutmeg. The heart reveals sugar and vanilla sweetness, while the base returns to oud, sandalwood, and herbal notes. A balanced oud fragrance that\'s sweet but not overwhelming — perfect for oud beginners.', notes: 'Woodsy Notes, Agarwood (Oud), Saffron, Nutmeg, Sugar, Vanilla, Sandalwood, Herbal Notes' },
  'ameer al oudh': { desc: 'Opens with woody notes and rich agarwood (oud), often with touches of saffron and nutmeg. The heart reveals sugar and vanilla sweetness, while the base returns to oud, sandalwood, and herbal notes. A balanced oud fragrance that\'s sweet but not overwhelming — perfect for oud beginners.', notes: 'Woodsy Notes, Agarwood (Oud), Saffron, Nutmeg, Sugar, Vanilla, Sandalwood, Herbal Notes' },
  'awen serene by me legenda': { desc: 'A serene, meditative fragrance featuring fresh green tea, bright bergamot, lemon, and calming lavender. Mossy warmth blends with luxurious soft oud, exotic saffron, and subtle tobacco for depth. Peaceful yet intriguing — ideal for those who seek tranquility with character.', notes: 'Green Tea, Bergamot, Lemon, Lavender, Moss, Soft Oud, Saffron, Tobacco' },
  'awen serene': { desc: 'A serene, meditative fragrance featuring fresh green tea, bright bergamot, lemon, and calming lavender. Mossy warmth blends with luxurious soft oud, exotic saffron, and subtle tobacco for depth. Peaceful yet intriguing — ideal for those who seek tranquility with character.', notes: 'Green Tea, Bergamot, Lemon, Lavender, Moss, Soft Oud, Saffron, Tobacco' },
  'magic voyage': { desc: 'A gourmand journey opening with rich caramel and buttery notes. The heart features honey, tonka bean, and delicate jasmine, while vanilla, amber, and musk create a cozy, enveloping dry-down. Sweet, dreamy, and comforting — like a magical voyage through a patisserie.', notes: 'Caramel, Butter, Honey, Tonka, Jasmine, Vanilla, Amber, Musk' },
  'noir': { desc: 'A dark, sophisticated spice-woody fragrance opening with pimento, cinnamon, nutmeg, and bergamot. The heart features elemi, mahonial, and lavender, while cedarwood, amber, sandalwood, vetiver, and vanilla form a powerful base. Mysterious, elegant, and unmistakably masculine.', notes: 'Pimento, Cinnamon, Nutmeg, Bergamot, Elemi, Mahonial, Lavender, Cedarwood, Amber, Sandalwood, Vetiver, Vanilla' },
  'exile scents': { desc: 'An artistic, nomadic fragrance opening with crisp bergamot, artemisia, and green violet leaf. The heart features powdery orris, orange blossom, and hay, while earthy notes, suede, and styrax create an intriguing dry-down. Unique, intellectual, and beautifully unconventional.', notes: 'Bergamot, Artemisia, Violet Leaf, Orris, Orange Blossom, Hay, Earthy Notes, Suede, Styrax' },
  'l707 men': { desc: 'A dynamic fresh-fruity fragrance with aldehydes, bergamot, ginger, mint, and lemon. The heart features apple, violet leaf, pineapple, sage, and geranium, while ambergris, musk, cedar, and balsam fir anchor the composition. Energetic, youthful, and incredibly versatile.', notes: 'Aldehydes, Bergamot, Ginger, Mint, Lemon, Apple, Violet Leaf, Pineapple, Sage, Geranium, Ambergris, Musk, Cedar, Balsam Fir' },
  'bouquet immortel': { desc: 'Centered around the fascinating immortelle flower — smelling of honey, hay, tobacco, and warm spices. Blended with sage, amber, woods, and musk for a unique, golden, sun-dried quality. Earthy, nostalgic, and utterly distinctive — a fragrance that tells a story.', notes: 'Immortelle (Helichrysum), Sage, Honey, Tobacco, Hay, Amber, Woods, Musk' },
  'rhythm immortel silver': { desc: 'A metallic-fresh fragrance opening with energizing lemon zest, verbena, and cyclamen petals. The heart blooms with magnolia, amber crystal, and jasmine, while silver leaves, patchouli, and musk create a sleek, modern dry-down. Clean, contemporary, and confidently masculine.', notes: 'Lemon Zest, Verbena, Cyclamen, Magnolia, Amber Crystal, Jasmine, Silver Leaves, Patchouli, Musk' },
  'masafi': { desc: 'A vibrant fruity-floral opening with mango, saffron, lemon, and pink pepper. The heart features osmanthus, violet leaf, orange blossom, and ginger, while everlasting flower, amber, mineral notes, and suede create an elegant finish. Modern, colorful, and effortlessly chic.', notes: 'Mango, Saffron, Lemon, Pink Pepper, Osmanthus, Violet Leaf, Orange Blossom, Ginger, Everlasting Flower, Amber, Mineral Notes, Suede' },
  'slaycy dfp': { desc: 'A refined leathery fragrance opening with spicy cardamom, powdery iris, and violet. The heart features rich leather, papyrus, and amber, while sandalwood and Virginia cedar provide a sturdy, elegant base. Sophisticated, assertive, and impeccably dressed.', notes: 'Cardamom, Iris, Violet, Leather, Papyrus, Amber, Sandalwood, Virginia Cedar' },
  'intense le cidre': { desc: 'A warm autumn cider fragrance featuring crisp apple and pear spiced with cinnamon, clove, and ginger. Sweetened with caramel and vanilla, while musk and woods provide depth. Cozy, seasonal, and deliciously inviting — like wearing your favorite sweater on a fall day.', notes: 'Apple, Pear, Cinnamon, Clove, Ginger, Caramel, Vanilla, Musk, Woods' },
  'serene blue le man': { desc: 'A calming blue aromatic featuring lavender, mint, and subtle anise. The heart of benzoin and honey adds warmth, while tonka bean, tobacco, cedar, and amber create a soothing base. Tranquil, modern, and comfortably masculine — perfect for daily serenity.', notes: 'Lavender, Mint, Anise, Benzoin, Honey, Tonka Bean, Tobacco, Cedar, Amber' },
  'apple cider vinegar': { desc: 'A sparkling fruity fragrance capturing the essence of mulled apple cider. Juicy apple meets warming cinnamon, allspice, clove, and orange zest, sweetened with caramel and vanilla on a woody base. Festive, cheerful, and irresistibly wearable year-round.', notes: 'Sparkling Apple, Cinnamon, Allspice, Clove, Orange Zest, Caramel, Vanilla, Woods' },
  'house of baiden kilian': { desc: 'A luxurious gourmand-floral inspired by Kilian style — opening with neroli, rose, and honeysuckle. The heart features addictive marshmallow, while cistus labdanum, vanilla, coconut, and guaiac wood create a rich, sensual base. Decadent, romantic, and utterly irresistible.', notes: 'Neroli, Rose, Honeysuckle, Marshmallow, Cistus Labdanum, Vanilla, Coconut, Guaiac Wood' },
  'liquide illusion': { desc: 'An ethereal powdery fragrance opening with almond, heliotrope, and violet. The creamy heart features iris, orris butter, and tuberose, while musk, tonka bean, amber, and siam benzoin create a soft, addictive dry-down. Dreamy, feminine, and enchantingly beautiful.', notes: 'Almond, Heliotrope, Violet, Iris, Orris Butter, Tuberose, Musk, Tonka Bean, Amber, Siam Benzoin' },
